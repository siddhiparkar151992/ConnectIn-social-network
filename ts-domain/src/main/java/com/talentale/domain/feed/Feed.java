package com.talentale.domain.feed;

import java.sql.Date;
import java.util.List;

import com.talentale.domain.post.Post;
...
public class Feed {
	 ...
	 * @param posts
	 */
	public Feed(long id, Date createdDate, Date updatedDate, FeedType feedType, List<Post> posts) {
		super();
		this.id = id;
