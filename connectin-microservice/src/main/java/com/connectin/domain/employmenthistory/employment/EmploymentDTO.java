...
import com.connectin.common.domain.Achievement;
import com.connectin.domain.company.CompanyDTO;
...
public class EmploymentDTO {
	 ...
	 * @param empType
	 */
	public EmploymentDTO(int id, CompanyDTO company, List<ProjectDTO> projects, Date startDate, EmploymentType empType) {
		super();
		this.id = id;
