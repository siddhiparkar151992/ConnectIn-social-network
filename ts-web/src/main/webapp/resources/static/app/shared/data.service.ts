...
import {LoanDetails, FundTransferList, AuthFundTrans, AuthOTPFundTransfer, AuthOTPlinkAcct, AccountList, TransDetails, AccountSummary, Transaction, LinkedAccount} from './data-model'
